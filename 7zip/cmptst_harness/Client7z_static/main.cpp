...
#endif
#include "../../3p/7zip/CPP/7zip/Common/CreateCoder.h"
#include "../../3p/7zip/CPP/7zip/UI/Common/LoadCodecs.h"
...
extern "C" const GUID CLSID_CArchiveHandler = { 0x23170F69, 0x40C1, 0x278A, { 0x10, 0x00, 0x00, 0x01, 0x10, 0x00, 0x00, 0x00 } };;

DEFINE_GUID_ARC(CLSID_Format,kId_7z)
CExternalCodecs g_ExternalCodecs; // <-- define exactly once in the whole link
...
#pragma GCC diagnostic ignored "-Wc++98-compat-pedantic"
    ...
    if(c=='a'){
        ...
        if(CreateArchiver(&CLSID_Format,&IID_IOutArchive,(void**)&outArchive)!=S_OK){
        ...
        */
        ...
        if(CreateArchiver(&CLSID_Format,&IID_IInArchive,(void**)&archive)!=S_OK){
            PrintError("Cannot get class object");
            return 1;
        }
